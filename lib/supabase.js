...
/*
  ...
  -- If the events table already exists, add the image_url column:
  ALTER TABLE events ADD COLUMN IF NOT EXISTS image_url TEXT;

  -- Create a public Supabase Storage bucket for party flyer images:
  -- Go to Storage → New bucket → Name: "event-flyers" → Public: ON
